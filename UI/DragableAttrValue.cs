...
namespace RitualOfAnkaraz.UI
{
    ...
    public class DragableAttrValue : MonoBehaviour, IDragHandler, IEndDragHandler, IBeginDragHandler ,IComparable<DragableAttrValue>
    {
        ...
        [SerializeField] public AttrDrop attributeDropHolder;

        /// <summary>
        /// Used to Load the values of the attributes when swapping between different chracters in creation.
        /// </summary>
        ...
        /// <summary>
        /// Handles the behavior of the draggable attribute.
        /// 
        /// </summary>
        /// <param name="eventData"></param> this is looking for an Attribute UI elemnt to drop the stat value
        public void OnEndDrag(PointerEventData eventData)
        {
            //is dropped on an attribute
            //attrDrop.OnDrop() handles the asignment of data.
        ...
        //IDK if its better to implement recursive IComoarable here. seems like a loot of work when I'm just telling him compare the base value anyway. Seems like a violation to the KISS Principle.
