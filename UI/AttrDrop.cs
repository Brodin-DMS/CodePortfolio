...
{
    /// <summary>
    /// this is receives the draggable Ui object to asign stats. It is attached to attributes in the mainMenuscene. It supports drag and drop as well as click to assign
    /// </summary>
    public class AttrDrop : MonoBehaviour, IDropHandler, IPointerClickHandler
    {
        ...
        {
            //check if an attribute is already attached
            if(dragableAttrValue != null)
            {
                dragableAttrValue.modifiedValue = dragableAttrValue.baseValue;
            ...
            Debug.Log("On dropped On GameObject" + gameObject.name);
